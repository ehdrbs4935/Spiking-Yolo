...
class Annotator:
    """
    Ultralytics Annotator for backbone_C2f_Bottleneck/val mosaics and JPGs and predictions annotations.
    ...
    for f in files:
        try:
            ...
            for i, j in enumerate(index):
                ...
                # if j in [8, 9, 10]:  # share backbone_C2f_Bottleneck and val loss y axes
